  ...
  return (
    <div className="w-full flex flex-row justify-between items-center px-16 h-[10vh] z-50">
        <Link className="h-20 w-auto flex justify-center items-center" href={'/'}>
          <img src="/ACCESSSCRIPTLOGO.png" className="object-cover h-8 w-auto hover:scale-110 transition-all duration-300 ease-out"></img>
          <img src="/ACCESSSCRIPTTITLE.png" className="object-cover h-4 w-auto ml-2"></img>
        </Link>
